        ...
        <div class="menu-btn-div hide-on-small-only"  onclick="onMenuBtnClick()">
            <p class="menu-btn-text" style="transform-origin:left;display:inline-block"><span class="menu-btn-text-p">MENU</span>
                <span class="menu-btn-bar"></span>
            </p>
        </div>
        <div class="menu-btn-div hide-on-med-and-up"  onclick="onMenuBtnClick()">
        ...
        <div class="navbar-div">
            <div style="width:100vw;height:100vh;position:relative">
                ...
                <div class="menu-content-container-div" style="width:100vw">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col l6 m12 s12 menu-option-div" style="postion:relative;overflow-y:auto">
                            ...
                            <div class="col l6 m12 s12 hide-on-med-and-down white-text" style="padding-top:100px;">
                                <span class="menu-div-text-bar-span"></span>
                                <p style="font-weight:200 !important" class="menu-div-text-p">
                                    Humans thrive for rhythm. Art is the purest fulfilment of the yearn for harmony. One has absolute control over his art, yet what you spawn awes you, for even with complete clou
                                </p>
                            </div>
                        </div>
                    </div>
