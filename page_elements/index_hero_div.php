        ...
        <div class="hero-div white">
            <div class="start-a-project-div-btn hide-on-small-only">
                <a href="#" style="color:#191919;">
                    <p class="start-a-project-div-btn-p" style="color:#191919;font-size:14px">
                        <span class="start-a-project-div-btn-bar-span" style=""></span>
                        START A PROJECT
                    </p>
                </a>
            </div>
